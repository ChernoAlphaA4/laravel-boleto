...
abstract class AbstractBoleto implements BoletoContract
{
  ...
  /**
   * Primeira mensagem do segmento R
   */
  protected $mensagem3 = '';

  /**
   * Segunda mensagem do segmento R
   */
  protected $mensagem4 = '';
  ...
  {
    return array_slice((array)$this->descricaoDemonstrativo + [null, null, null, null, null, null, null, null], 0, 8);
  }
  ...
  /**
   * Retorna o codigo da multa para o segmento R
   *
   * @return float
   */
  ...
  /**
   * Define o codigo da multa para o segmento R
   * 1- Valor fixo, 2- Percentual
   * @param $cod - Codigo da multa
   * @return float
   */
  public function setCodigoMulta($cod)
  {
  ...
  /**
   * Retorna a data da multa para o segmento R
   *
   * @return float
   */
  ...
  /**
   * Define a data da multa para o segmento R
   *
   * @param Carbon $data
   * @return AbstractBoleto
   */
  ...
  /**
   * Retorna o codigo do desconto para o segmento P
   * @return mixed
   */
   ...
   * @return mixed
   */
  public function setCodigoDesconto($d1)
  {
    $this->codigoDesconto = $d1;
    return $this;
  }
