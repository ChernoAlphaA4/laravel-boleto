...
class Caixa extends AbstractRemessa implements RemessaContract
{
  ...
  protected function segmentoP(BoletoContract $boleto)
  {
    ...
    $this->add(38, 39, '00');
    $this->add(40, 40, strlen($boleto->getNossoNumero()) == 17 ? '0' : '9');
  ...
  {
    /** @var \Eduardokum\LaravelBoleto\Boleto\Banco\Caixa $boleto */
    $this->iniciaDetalhe();
    $this->add(1, 3, Util::onlyNumbers($this->getCodigoBanco()));
    $this->add(4, 7, '0001');
    $this->add(8, 8, '3');
  ...
  protected function headerLote()
  {
    ...
    $this->add(60, 65, Util::formatCnab('9', (int)$this->getCodigoCliente() < 1000000 ? Util::onlyNumbers($this->getCodigoCliente()) : 0, 6));
    $this->add(66, 72, '0000000');
    $this->add(73, 73, '0');
