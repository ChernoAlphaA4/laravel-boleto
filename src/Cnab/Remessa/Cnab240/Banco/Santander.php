...
class Santander extends AbstractRemessa implements RemessaContract
{
  ...
  protected function segmentoP(BoletoContract $boleto)
  {
    ...
    $this->add(118, 118, Util::formatCnab('9', $boleto->getCodigoJurosMora(), 1));
    ...
    $this->add(142, 142, Util::formatCnab('9', $boleto->getCodigoDesconto(), 1));
  ...
  public function segmentoQ(BoletoContract $boleto)
  {
    ...
    $this->add(15, 15, '');
    $this->add(16, 17, Util::formatCnab('9', 01, 2));
    $this->add(18, 18, Util::formatCnab('9', $this->getInscricao($boleto->getPagador()->getDocumento()), 1));
    ...
    $this->add(154, 154, Util::formatCnab('9', 0, 1));
  ...
  public function segmentoR(BoletoContract $boleto)
  {
    ...
    $this->add(15, 15, '');
    $this->add(16, 17, Util::formatCnab('9', 01, 2));
    $this->add(18, 18, Util::formatCnab('9', $boleto->getCodigoDesconto2(), 1));
    $this->add(19, 26, Util::formatCnab('9', $boleto->getDataDesconto2(), 8));
    $this->add(27, 41, Util::formatCnab('9', $boleto->getDesconto2(), 15));
    $this->add(42, 65, '');
    $this->add(66, 66, Util::formatCnab('9', $boleto->getCodigoMulta(), 1));
    $this->add(67, 74, Util::formatCnab('9', $boleto->getDataMulta(), 8));
    $this->add(75, 89, Util::formatCnab('9', $boleto->getMulta(), 15, 2));
    $this->add(90, 99, '');
    $this->add(100, 139, Util::formatCnab('X', $boleto->getMensagem3(), 40));
    $this->add(140, 179, Util::formatCnab('X', $boleto->getMensagem4(), 40));
    $this->add(180, 240, '');
  ...
  public function getCodigoTransmissao()
  {
    return Util::formatCnab('9', $this->getAgencia(), 4)
      . Util::formatCnab('9', $this->getCodigoCliente(), 11);
