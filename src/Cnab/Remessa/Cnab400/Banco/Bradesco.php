...
class Bradesco extends AbstractRemessa implements RemessaContract
{
  ...
  public function registroTipo1(BoletoContract $boleto){
    ...
    if ($boleto->getDiasProtesto() > 0) {
      ...
      $this->add(159, 160, Util::formatCnab('9', $this->getDiasParaBaixa(), 2));
    }
  ...
  public function registroTipo2(BoletoContract $boleto){
    ...
    $this->add(360, 366, '');
    $this->add(367, 369, Util::formatCnab('9', $this->getCarteira(), 3));
    $this->add(370, 374, Util::formatCnab('9', $this->getAgencia(), 5));
    $this->add(375, 381, Util::formatCnab('9', $this->getConta(), 7));
    $this->add(382, 382, Util::formatCnab('9', $this->getContaDv(), 1));
